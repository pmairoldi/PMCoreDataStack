...
// Swift-RAC-Macros
#define COCOAPODS_POD_AVAILABLE_Swift_RAC_Macros
#define COCOAPODS_VERSION_MAJOR_Swift_RAC_Macros 0
#define COCOAPODS_VERSION_MINOR_Swift_RAC_Macros 1
#define COCOAPODS_VERSION_PATCH_Swift_RAC_Macros 0
